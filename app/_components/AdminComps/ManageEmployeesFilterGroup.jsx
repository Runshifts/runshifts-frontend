...
function ManageEmployeesFilterGroup() {
  return (
    <section>
      <div className="flex items-center justify-start my-4">
        <div className="w-screen flex items-center justify-start">
          ...
          <select
          className="bg-[#F4F5F7] border-none text-xs text-[#7A869A] my-2 h-10 rounded-md  md:text-sm "
          aria-label="Default select example"
        >
...
export default ManageEmployeesFilterGroup;
