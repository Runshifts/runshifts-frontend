...
function ManageEmployersFilterGroup() {
  return (
    <section>
      <div className="flex items-center justify-start my-4">
        <div className="flex items-center justify-start">
          <input
            ...
            className="bg-[#F4F5F7] border-none text-[#7A869A] my-2 mr-2 h-10 w-fit rounded-md flex justify-between items-center"
            name="employees"
          />
          <select
            className="bg-[#F4F5F7] border-none text-[#7A869A] m-2 mx-2 h-10 w-32 rounded-md flex justify-between items-center"
        ...
        {/* <div className="flex justify-start items-center md:hidden">
          <select
            className="bg-[#F4F5F7] border-none text-[#7A869A] my-2 mr-2h-10 w-32 rounded-md flex justify-between items-center"
            aria-label="Default select example"
          >
...
export default ManageEmployersFilterGroup;
