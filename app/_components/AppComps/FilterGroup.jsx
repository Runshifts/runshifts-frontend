...
function FilterGroup() {
  return (
    <section>
        ...
        <div className="border py-3 px-1 w-32 rounded-md flex justify-between items-center md:hidden">
        ...
        <div className="hidden md:flex items-center justify-start">
          <select
            className="bg-gray-100 text-gray-500 m-2  h-10 w-32 rounded-md flex justify-between items-center"
