    ...
    <section>
      <div className="flex items-center justify-start my-4">
        ...
        <input
          ...
          className="bg-gray-100 px-2 py-2 mr-2 text-gray-500 rounded-md md:hidden"
          name="members"
        />
        {/* </div> */}
        ...
        <div className="border py-2 px-1 w-fit rounded-md flex justify-between items-center">
