...
//                                 <li key={index} className={item.dropdown ? 'relative' : ''}>
//                                     {!item.isButton ? (
//                                         <div className={`flex items-center py-2 px-3 ${textColorClass} rounded xl:bg-transparent xl:p-0`}>
//                                             <a href={item.href}>
//                                                 {item.label}
//                                             </a>
//                                             {item.dropdown && (
//                                                 <button
//                                                     onClick={() => setIsDropdownOpen(!isDropdownOpen)}
//                                                     className={`flex items-center justify-between w-full py-2 px-3 ${textColorClass} rounded hover:bg-gray-100 xl:hover:bg-transparent xl:border-0 xl:p-0 xl:w-auto dark:text-white xl:dark:hover:text-blue-500 dark:focus:text-white dark:border-gray-700 dark:hover:bg-gray-700 xl:dark:hover:bg-transparent`}
//                                                 >
//                                                     <svg className="w-2.5 h-2.5 ml-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
//                                                         <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m1 1 4 4 4-4" />
//                                                     </svg>
...
//             {/* Mobile Menu Overlay */}
//             {isMobileMenuOpen && (
//                 <div className="fixed inset-0 z-10 bg-black bg-opacity-75 xl:hidden">
//                     <div className="absolute top-0 left-0 w-full h-full">
//                         <nav className="p-4">
//                             <ul className="flex flex-col space-y-4 text-white">
//                                 {menuItems.map((item, index) => (
