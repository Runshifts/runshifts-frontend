                            ...
                            {menuItems.map((item, index) => (
                                <li key={index} className={item.dropdown ? 'relative' : ''}>
                                        ...
                                        <div className={`flex items-center py-2 px-3 text-[#000] rounded xl:bg-transparent xl:p-0`}>
                                            ...
                                            {item.dropdown && (
                                                <button
                                                    ...
                                                    className="flex items-center justify-between w-full py-2 px-3 text-[#000] rounded hover:bg-gray-100 xl:hover:bg-transparent xl:border-0 xl:p-0 xl:w-auto dark:text-white xl:dark:hover:text-blue-500 dark:focus:text-white dark:border-gray-700 dark:hover:bg-gray-700 xl:dark:hover:bg-transparent"
                                                >
                                    ...
                                    {isDropdownOpen && item.dropdown && (
                                        ...
                                        >
                                            <ul className="py-2 text-sm font-normal text-[#000]">
