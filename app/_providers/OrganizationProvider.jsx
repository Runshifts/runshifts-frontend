...
export default function OrganizationProvider({ children }) {
  ...
  const [isFetchingOrganization, setIsFetchingOrganization] = useState(organization === null)
  ...
  return (
    <OrganizationContext.Provider value={{ organization, fetchOrganization, isFetchingOrganization }}>
      {children}
