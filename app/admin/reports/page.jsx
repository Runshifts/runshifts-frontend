...
import ReportsTickets from './ReportsTickets'
function page() {
  return (
    <section className="p-6 h-screen">
     <div className="flex items-center justify-between">
        <h1 className="custom-h1 ">Reports</h1>

          <button className="hidden md:block bg-gray-100 rounded ml-1 px-2 py-1">
...
<path d="M15.4183 7.24988C15.2283 7.24988 15.0383 7.17988 14.8883 7.02988L12.8583 4.99988L10.8283 7.02988C10.5383 7.31988 10.0583 7.31988 9.76828 7.02988C9.47828 6.73988 9.47828 6.25988 9.76828 5.96988L12.3283 3.40988C12.6183 3.11988 13.0983 3.11988 13.3883 3.40988L15.9483 5.96988C16.2383 6.25988 16.2383 6.73988 15.9483 7.02988C15.7983 7.17988 15.6083 7.24988 15.4183 7.24988Z" fill="#42526E"/>
<path d="M12.8584 14.93C12.4484 14.93 12.1084 14.59 12.1084 14.18V4.01001C12.1084 3.60001 12.4484 3.26001 12.8584 3.26001C13.2684 3.26001 13.6084 3.60001 13.6084 4.01001V14.18C13.6084 14.6 13.2684 14.93 12.8584 14.93Z" fill="#42526E"/>
<path d="M12.9785 20.75C7.82852 20.75 4.22852 17.15 4.22852 12C4.22852 11.59 4.56852 11.25 4.97852 11.25C5.38852 11.25 5.72852 11.59 5.72852 12C5.72852 16.27 8.70852 19.25 12.9785 19.25C17.2485 19.25 20.2285 16.27 20.2285 12C20.2285 11.59 20.5685 11.25 20.9785 11.25C21.3885 11.25 21.7285 11.59 21.7285 12C21.7285 17.15 18.1285 20.75 12.9785 20.75Z" fill="#42526E"/>
</svg>
