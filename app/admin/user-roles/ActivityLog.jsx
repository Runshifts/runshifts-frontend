...
const AllEmployeesTable = () => {
  const employeeData = [
    {
      account: "Updated user2134 email",
      time: "12:25 PM",
      empName: "John Doe",
      image: Avatar,
    },
    {
      account: "Approved user account",
      time: "12:25 PM",
      empName: "Jonah Ford",
      image: Avatar,
    },
    {
      account: "Added new employer",
      time: "12:25 PM",
      empName: "John Doe",
      image: Avatar,
    },
    {
      account: "BAdded new employer",
      time: "12:25 PM",
      empName: "Jonah Ford ",
      image: Avatar,
    },
  ...
  return (
    <section>
        <h1 className="text-gray-900 text-base not-italic font-semibold my-5">
        Activity Log
      </h1>
      ...
      {employeeData.map((employee, index) => (
        ...
        >
          ...
          <div className="flex items-center justify-start">
            <div className="text-[#1D2433] text-sm mr-20">
              {employee.account}
            </div>

            <div className="text-[#1D2433] text-sm mr-20">{employee.time}</div>

            <div className="ml-auto flex space-x-2">
              <button className="bg-[#5BC62D] rounded text-white py-0.5 px-2">
