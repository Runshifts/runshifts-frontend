  ...
  return (
    <>
      <div className="confirm-bg h-screen bg-cover bg-center flex items-center justify-start"> 
              <div className="mx-auto md:pl-8 ml-8 pt-4">
          <div className="w-full max-w-sm ">
            <div className="bg-white shadow-md rounded-md px-8 pt-6 pb-8 mb-4">
              <div className=" bg-white rounded-md">
                <h1 className="py-2 text-2xl font-semibold leading-12 tracking-tight text-left text-[#1B1818]">Provide the code sent to your mail box</h1>

                <p className="text-xs text-gray-800 font-semibold my-2">
