    ...
    <Layout>
      <section className="bg-white">
        <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-sm">
          ...
          <InnerHeader>Get in touch</InnerHeader>
          <CommonParagraph>
          ...
          <form action="#" className="space-y-8">
            ...
            <div className="mx-auto">
              <CommonButtons>Send message</CommonButtons>
            </div>
          </form>
        </div>
        ...
        <div className="flex flex-col items-center justify-between gap-16 mx-8 my-5 xl:flex-row xl:mx-28 xl:my-10">
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <CommonParagraph>Come say hello at our office HQ.</CommonParagraph>
            <p className="text-center text-[#2D6316] text-xs not-italic font-bold leading-6 md:text-sm">
              100 Smith Street
              <br />
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <CommonParagraph>Mon-Fri from 8am to 5pm.</CommonParagraph>
            <p className="text-center text-[#2D6316] text-xs not-italic font-bold leading-6 md:text-sm">
              +1 (800) 123-4567
            </p>
          </div>
