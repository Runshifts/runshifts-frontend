  ...
  return (
    ...
    <div className="">
      <div className="bg-gradient-radial from-[#FD9] via-[#CBF0BC] to-white flex flex-col items-center justify-center px-54 py-6 pt-16">
        ...
        <h1 className="capitalize text-center text-4xl not-italic font-extrabold text-[#36322F] my-6 md:text-6xl">
        Supercharge Your
          <br /> Team
        </h1>
        <CommonParagraph>
          <p className="text-sm text-center">
          Streamline scheduling, timekeeping, communication, and reporting to<br/> drive efficiency across your workforce.
          </p>
        </CommonParagraph>
        ...
        <div className="flex items-center justify-center my-6">
          ...
          Join businesses and start scheduling to<br/> get your team working efficiently.
          </p>
        </div>    
...
<div className='px-16'>
      ...
      <div className="flex justify-center items-center gap-4 flex-col xl:flex-row my-8 ">
        <div className="p-5 rounded-xl mx-3">
          ...
          Emphasizes the platform&apos;s ability to provide up-to-the-minute workforce oversight.          </p>
        </div>
        ...
        <div className="p-3 border border-dashed rounded-xl mx-3">
          ...
          <p className="text-base not-italic font-normal leading-6 text-[#52525B] py-2">
          Assures users that financial transactions are protected.          </p>
        </div>
      ...
      <div className="flex flex-col items-center justify-around gap-4 bg-[#1A212C] rounded-2xl p-8 my-8 xl:flex-row xl:my-20">
        <Image src={Illustration} alt="Illustration" height={477} width={384} />
        <div className="flex flex-col items-start justify-start p-8">
          ...
          <CommonParagraph>
            ...
            Streamline your team&apos;s scheduling and shift management with Runshifts. Our intuitive platform makes it easy to create, update, and coordinate shifts in real-time. Keep your workforce informed and operations running smoothly.
            </div>
          </CommonParagraph>
          <Link href={'/signup?type=for-profit'}>
      ...
      <div className="flex flex-col-reverse items-center justify-between gap-4 p-8 md:flex-row my-20">
        <div className="flex flex-col items-start justify-start p-8">
          <h2 className="text-center text-2xl not-italic font-semibold rounded-full text-[#36322F] my-2 md:text-5xl md:my-4 ">
            Fully integrated teams communication and operation features
          </h2>
          <CommonParagraph>
          Runshifts integrates seamless team communication with comprehensive operational tools. Keep your workforce connected and your business running efficiently all in one platform.
          </CommonParagraph>
        </div>
        <Image
          src={Illustration1}
      ...
      <div className="w-full flex flex-col items-center justify-center gap-4 bg-[#E5F7DD] rounded-2xl p-2 my-8 xl:flex-row xl:p-8 xl:my-20">
        <div className="flex flex-col items-center justify-center bg-[#B2E89A] rounded-2xl  md:w-1/2 p-6">
          <Image src={Table2} alt="" height={92} width={492} className="" />
          <Image src={Table1} alt="" height={434} width={392} />
        </div>
        <div className="flex flex-col justify-start items-start ml-6 p-8 text-left md:w-1/2">
        ...
        <div className="flex flex-col items-start justify-center ">
          ...
          <CommonParagraph>
            <div className="break-words">
              ...
              charitable organizations. Streamline your workforce management to
            ...
            <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
              ...
              <div class="p-5">
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                  What are other companies doing to function with ease?
                </h5>
