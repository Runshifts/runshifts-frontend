...
function TrackerContent({ todaysShift, isVolunteer }) {
    ...
    <div className="flex flex-col gap-4">
      <div className="grid grid-cols-1 gap-4 sm:flex sm:justify-center sm:flex-wrap lg:justify-start lg:grid-cols-3">
        <TrackerCard
          ...
          unit={new Date(todaysShift?.startTime).getHours() > 12 ? "PM" : "AM"}
        ...
        <TrackerCard
          ...
          unit={new Date(todaysShift?.endTime).getHours() > 12 ? "PM" : "AM"}
          buttonText={
            todaysShift?.endedAt ||
            new Date(todaysShift?.endTime).getTime() < Date.now()
              ? "Checked Out"
